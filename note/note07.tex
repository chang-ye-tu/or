...
\begin{document}
\title{\texorpdfstring{\vspace{15mm} 作業研究\\ 07. Duality}{作業研究\\ 07. Duality}} 
\author{}
\date{}
\maketitle
\newpage
...
\begin{itemize}
  \item dual function 
    ...
    \end{align*}
    where $\ds f_0^\star(y)\equiv\sup_{x\in\dom f} y^\top x - f(x)$ is {\bf conjugate} of $f_0$
