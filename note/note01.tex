...
\usepackage{amsmath,amsfonts,amssymb,amsthm,graphicx,xcolor,natbib,enumitem}
...
\begin{document}
\title{\texorpdfstring{\vspace{15mm} 作業研究 \\ 01. Orientation and Introduction}{作業研究 \\ 01. Orientation and Introduction}}
\author{}
...
\begin{itemize}[itemsep=0mm]
  ...
  \item Sequential Decision Problems
    ...
    \end{itemize}
  \item Jupyter Notebook: \LaTeX{} \& Markdown 
