...
\begin{document}
\title{\texorpdfstring{\vspace{15mm} Operations Research\\ 02. Jupyter Notebook: Markdown}{Operations Research\\ 02. Jupyter Notebook: Markdown}} 
\author{}
\date{}
\maketitle
\newpage
...
\begin{itemize}
  ...
  \item Execute in shell: {\tt jupyter notebook}
...
\section*{Jupyter Notebook Markdown 1}
...
\begin{itemize}
  ...
  \item emphasis: use the following to emphasize text
    ...
    \end{itemize}
  \item mathematical symbols using \LaTeX{}
  \item most raw html rules apply 
\end{itemize}

\newpage

\section*{Jupyter Notebook Markdown 2}
...
\begin{itemize}
  ...
  \item indenting using {\tt >} followed by a space
\end{itemize}

\newpage

\section*{Jupyter Notebook Markdown 3}
...
\section*{Jupyter Notebook Markdown 4}
